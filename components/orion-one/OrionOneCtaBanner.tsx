...
interface OrionOneCtaBannerProps {
  onOpenInquiry?: () => void;
}

export default function OrionOneCtaBanner({
  onOpenInquiry,
}: OrionOneCtaBannerProps) {
  ...
  return (
    <section className="relative py-24 sm:py-36 bg-[#153D3D] text-[#EDE5DA] overflow-hidden">
      {/* Ambient background glow vignette */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-[#62AA9E]/8 rounded-full blur-[200px] pointer-events-none -z-10"
        aria-hidden="true"
      />
      ...
      >
        ...
        <h2 className="font-serif-heading text-4xl sm:text-6xl lg:text-7xl font-light text-[#EDE5DA] leading-[1.08] uppercase max-w-4xl mx-auto">
        ...
        <div className="pt-4 flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          <Link
            ...
            className="inline-flex items-center gap-2.5 text-[11px] font-bold uppercase tracking-[0.2em] bg-[#62AA9E] hover:bg-[#7ec1b6] text-[#0d2828] px-8 py-4 rounded-full transition-all duration-500 ease-[cubic-bezier(0.75,0,0.25,1)] shadow-xl hover:shadow-[#62AA9E]/20 hover:-translate-y-0.5 cursor-pointer"
          >
        ...
        <div className="pt-10 border-t border-[#EDE5DA]/10 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-[#808080] font-sans-body">
          ...
          <span>
            4th Floor, District 101, Bahria Town (Phase VIII), Islamabad
          </span>
          <span className="hidden sm:inline">·</span>
