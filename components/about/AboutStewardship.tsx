      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="max-w-4xl mb-16 sm:mb-24 space-y-4">
          <p className="font-sans-body text-[11px] sm:text-xs font-semibold uppercase tracking-[0.35em] text-[#62AA9E]">
            SP Builders Architectural Standard
          </p>
        ...
        <div className="relative rounded-2xl bg-[#081a1a] p-8 sm:p-14 lg:p-16 border border-[#EDE5DA]/15 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h3 className="font-serif-heading text-3xl sm:text-4xl lg:text-5xl font-light text-[#EDE5DA] tracking-tight leading-[1.12]">
            ...
            <div className="lg:col-span-5 border-t lg:border-t-0 lg:border-l border-[#EDE5DA]/15 pt-8 lg:pt-0 lg:pl-12 space-y-5">
              <button
                onClick={onOpenInquiry}
                className="w-full inline-flex items-center justify-between text-xs font-bold uppercase tracking-[0.2em] bg-[#62AA9E] hover:bg-[#7ec1b6] text-[#0d2828] px-8 py-4.5 rounded-full transition-all duration-300 shadow-xl cursor-pointer"
              >
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-between text-xs font-medium uppercase tracking-[0.2em] text-[#EDE5DA]/90 hover:text-[#62AA9E] px-8 py-4 border border-[#EDE5DA]/20 hover:border-[#62AA9E]/40 rounded-full transition-all duration-300 text-center"
              >
              ...
              <Link
                href="/#architecture"
                className="block text-center text-[10px] uppercase tracking-[0.25em] text-[#EDE5DA]/50 hover:text-[#62AA9E] transition-colors pt-2"
              >
                Return to 3D Scrubber Chapters →
              </Link>
            </div>
          </div>
        </div>
